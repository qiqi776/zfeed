...
func (l *ContentUploadsCredentialsLogic) ContentUploadsCredentials(req *types.ContentUploadsCredentialsReq) (resp *types.ContentUploadsCredentialsRes, err error) {
	...
	return builder.build(*req.Scene, *req.FileExt, *req.FileName, *req.FileSize)
}
...
func (b uploadCredentialBuilder) build(scene, fileExt, fileName string, fileSize int64) (*types.ContentUploadsCredentialsRes, error) {
