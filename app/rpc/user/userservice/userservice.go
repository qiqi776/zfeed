...
type (
	...
	UpdateProfileRes  = user.UpdateProfileRes
...
func (m *defaultUserService) UpdateProfile(ctx context.Context, in *UpdateProfileReq, opts ...grpc.CallOption) (*UpdateProfileRes, error) {
	client := user.NewUserServiceClient(m.cli.Conn())
