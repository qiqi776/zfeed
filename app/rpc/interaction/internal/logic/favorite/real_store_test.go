...
import (
	...
	followlogic "zfeed/app/rpc/interaction/internal/logic/follow"
...
func TestRealStoreFavoriteAndFollowFlow(t *testing.T) {
	...
	followLogic := followlogic.NewFollowUserLogic(ctx, interactionSvcCtx)
	unfollowLogic := followlogic.NewUnfollowUserLogic(ctx, interactionSvcCtx)
	listFolloweesLogic := followlogic.NewListFolloweesLogic(ctx, interactionSvcCtx)
	getFollowSummaryLogic := followlogic.NewGetFollowSummaryLogic(ctx, interactionSvcCtx)
